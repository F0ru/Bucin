      ...
      Swal.fire("Awas aja kalo boong!!", "", "error").then(function () {
        ...
        const {
          ...
          inputValidator: (value) => {
            if (!value) {
              return 'Kenapa gak masukin namanya? Masukin sekarang!'
            } else {
              nama = value;
            }
          }
              ...
              Swal.fire(`${sender} juga sayang banget sama ${nama}`).then(function () {
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah sayang sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      title: `beneran kan ${nama} sayang sama ${sender}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      confirmButtonText: `Bangettttt `,
                      denyButtonText: `Dih ngarep`,
                    }).then((result) => {
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        ...
                        Swal.fire('Yaudah deh gapapa', '', 'error').then(function () {
                          Swal.fire('Maaf ya ${sender} terlanjur sayang sama {nama}')
                        })
                      }
                    })
                  })
